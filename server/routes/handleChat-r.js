...
Suggest the about amount of quantity nutrition food about Fat, Saturates, Sugars, Salt in one product.
...
Save the calories suggestion into the format: cals: [value].
Save the food groups suggestion into the format: Food-Group: [value] (just give the food groups that i give you).
Save the Fat, Saturates, Sugars, Salt suggestion into the format: name of each nutrition : [value] (down line for each).
